...
![](images/engine.jpg){width=250px} ![](images/dashboard.jpg){width=250px}
...
- On the lower left we have the console window. This is where R is running, and this is what you would see if you opened R instead of RStudio. In this pane we can see the code we sent and then the answer.
